...
#define STRING_CONFIG_H_AUTHOR "Rasmus Gade" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Prutender 3"
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 200, 200, 30, 2*60 }
...
#define DEFAULT_RETRACT_ACCELERATION  12500    // E acceleration for retracts
#define DEFAULT_TRAVEL_ACCELERATION   12500    // X, Y, Z acceleration for travel (non printing) moves
 ...
 */
  ...
  #define JUNCTION_DEVIATION_MM 0.05 // (mm) Distance from real junction edge (this has been calculated from 0.4*jerk*jerk/acceleration which is 0.4*10*10/800 for this case)
...
#define NOZZLE_TO_PROBE_OFFSET { 23, 7, 0 }
