...
// @section lcd
  ...
  #define MANUAL_FEEDRATE { 2700, 2700, 1000, 100 } // (mm/m) Feedrates for manual moves along X, Y, Z, E from panel
...
#define CUSTOM_USER_MENUS
  ...
  #define USER_DESC_1 "Full Calibration" 
  ...
  #define USER_DESC_10 "Home & UBL Info"
